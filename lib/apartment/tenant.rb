...
module Apartment
  ...
  module Tenant
    ...
    def_delegators :adapter, :create, :drop, :switch, :switch!, :current, :each, :reset, :set_callback, :seed, :current_tenant, :default_tenant, :environmentify, :current_database_name
